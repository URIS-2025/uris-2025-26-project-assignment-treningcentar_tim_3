    ...
    return (
        <div className="p-8 max-w-6xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-2xl font-black text-white">Membership Verification</h1>
            ...
            {selectedMember && (
                <div className="space-y-6">
                    ...
                    {membershipLoading ? (
                        ...
                        <div className="bg-neutral-900 border border-rose-500/20 rounded-2xl p-8">
                            <div className="text-center">
                                <div className="w-16 h-16 mx-auto bg-rose-500/10 rounded-full flex items-center justify-center mb-4">
                                    <XCircle className="w-8 h-8 text-rose-400" />
                                </div>
                                <h3 className="text-xl font-black text-rose-400 mb-2">No Active Membership</h3>
                                <p className="text-neutral-500 text-sm mb-4">
                                    This member does not have any membership record. Booking is <strong className="text-rose-400">blocked</strong>.
                                </p>
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-rose-500/10 border border-rose-500/20 rounded-xl text-rose-400 text-sm font-bold">
                        ...
                        <div
                            className={`bg-neutral-900 border rounded-2xl p-6 ${isActive ? 'border-emerald-500/20' : 'border-rose-500/20'
                                }`}
                        >
                            {/* Status Banner */}
                            <div
                            ...
                            >
                                ...
                                <div>
                                    <p className={`text-sm font-black ${isActive ? 'text-emerald-400' : 'text-rose-400'}`}>
                            ...
                            <div className="mt-6">
                                {isActive ? (
                                    ...
                                    <button
                                        disabled
                                        className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-neutral-700 text-neutral-400 text-base font-black rounded-xl cursor-not-allowed opacity-60"
                                    >
